...
:return:
*/
    entry_update(entry_id: Identifier, changeset: EntryUpdate): Promise<Entry> {
        return this.boundary.remote('entry_update', entry_id, changeset) as Promise<Entry>
    }
